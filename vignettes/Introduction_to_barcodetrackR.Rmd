...
```{r clonal_contribution belderbos_SE, echo=TRUE, warning = FALSE, eval = FALSE}
...
```{r ridge_plot wu_SE 1, echo=FALSE, warning = FALSE, eval = TRUE}
...
```{r ridge_plot wu_SE 2, echo=FALSE, warning = FALSE, eval = TRUE}
wu_ridge_plot <- ridge_plot(your_SE = wu_SE[,wu_ridge_plot_sample_selection],
                            selection_var = "celltype",
                            selection_1 = "B",
                            selection_2 = "T",
...
```{r ridge_plot six_SE, echo=FALSE, warning = FALSE, eval = FALSE}
