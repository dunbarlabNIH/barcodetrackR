...
results_dir <- "/Users/mortlockrd/Desktop/barcodetrackR manuscript/figures v8"
```
...
bel_cc <- count_clones(belderbos_SE[,c(1:6, 13:16)],
                       plot_over = "weeks",
                       group_by = "celltype",
                       index_type = "count",
                       point_size = fig3_ptsz,
...
esp_cc <- count_clones(esp_SE[,colData(esp_SE)$celltype != "EOS"],
                       plot_over = "days",
                       group_by = "celltype",
                       index_type = "count",
                       point_size = fig3_ptsz,
...
## Figure S1: Cumulative clone number

```{r figure S1, eval = TRUE}

six_cumc <- count_clones(six_SE,
                       plot_over = "months",
                       group_by = "celltype",
                       index_type = "cumulative_count",
                       point_size = fig3_ptsz,
                       line_size = 1,
                       text_size = fig3_txsz)+
  ggplot2::theme(legend.key.height = ggplot2::unit(0.25, "cm"))

bel_cumc <- count_clones(belderbos_SE[,c(1:6, 13:16)],
                       plot_over = "weeks",
                       group_by = "celltype",
                       index_type = "cumulative_count",
                       point_size = fig3_ptsz,
...
esp_cumc <- count_clones(esp_SE[,colData(esp_SE)$celltype != "EOS"],
                       plot_over = "days",
                       group_by = "celltype",
                       index_type = "cumulative_count",
                       point_size = fig3_ptsz,
...
pdf(file = file.path(results_dir, "Figure_S1.pdf"), width = 10, height = 3)
...
<!-- ## Figure S2: Wu heatmap all cell types -->

<!-- ```{r figure S2, echo=TRUE, warning = FALSE, eval = TRUE} -->

<!-- figS2_txsz <- 8 -->

<!-- wu_heatmap_sample_selection <- colData(wu_SE)$SAMPLENAME[1:20] -->

<!-- wu_hm_all <- barcode_ggheatmap(your_SE = wu_SE[,wu_heatmap_sample_selection], -->
<!--                                n_clones = 10, -->
<!--                                cellnote_assay = "stars", -->
<!--                                cellnote_size = 2.5,     -->
<!--                                label_size = figS2_txsz, -->
<!--                                plot_labels = c("6m T", "9.5m T", "12m T", "20m T", -->
<!--                                                "6m B", "9.5m B", "12m B", "20m B", -->
<!--                                                "6m Gr", "9.5m Gr", "12m Gr", "20m Gr", -->
<!--                                                "6m NK 56", "9.5m NK 56", "12m NK 56", "20m NK 56", -->
<!--                                                "6m NK 16", "9.5m NK 16", "12m NK 16", "20m NK 16"), -->
<!--                                dendro = TRUE, -->
<!--                                clusters = 3, -->
<!--                                your_title = " ") -->

<!-- pdf(file = file.path(results_dir, "Figure_S2.pdf"), width = 11, height = 5) -->
<!-- cowplot::plot_grid(wu_hm_all, ncol = 1, labels = c("A")) -->
<!-- dev.off() -->
...
# Ridge plots
six_ridge <- ridge_plot(your_SE = six_SE,
...
ko_ridge <- ridge_plot(your_SE = koelle_SE,
                       split_bias_on = "celltype",
                       bias_1 = "Gr",
                       bias_2 = "T",
                       split_bias_over = "months",
...
ko_circos <- function() circos_plot(koelle_SE[,ko_circos_selection],
                                    weighted = TRUE,
                                    plot_label = "celltype",
                                    text_size = fig5_txsz)
six_circos_selection <- c("m55_GRANULOCYTES","m55_TCELLS","m55_MONOCYTES")
six_circos <- function() circos_plot(six_SE[,six_circos_selection],
                                     weighted = TRUE,
                                     plot_label = "celltype",
                                     text_size = fig5_txsz)
...
## Figure S2: Further Clonal Bias from Six et al
...
# Ridge plots
six_ridge2 <- ridge_plot(your_SE = six_SE,
                        split_bias_on = "celltype",
                        bias_1 = "Gr",
                        bias_2 = "Mo",
                        split_bias_over = "months",
                        weighted = TRUE,
                        add_dots = TRUE,
                        text_size = figS2_txsz)

six_ridge3 <- ridge_plot(your_SE = six_SE,
                        split_bias_on = "celltype",
                        bias_1 = "Gr",
                        bias_2 = "B",
                        split_bias_over = "months",
...
six_ridge4 <- ridge_plot(your_SE = six_SE,
                        split_bias_on = "celltype",
                        bias_1 = "Gr",
                        bias_2 = "NK",
                        split_bias_over = "months",
...
six_ridge5 <- ridge_plot(your_SE = six_SE,
                        split_bias_on = "celltype",
                        bias_1 = "Mo",
                        bias_2 = "T",
                        split_bias_over = "months",
...
six_ridge6 <- ridge_plot(your_SE = six_SE,
                        split_bias_on = "celltype",
                        bias_1 = "Mo",
                        bias_2 = "B",
                        split_bias_over = "months",
...
six_ridge7 <- ridge_plot(your_SE = six_SE,
                        split_bias_on = "celltype",
                        bias_1 = "Mo",
                        bias_2 = "NK",
                        split_bias_over = "months",
...
six_ridge8 <- ridge_plot(your_SE = six_SE,
                        split_bias_on = "celltype",
                        bias_1 = "T",
                        bias_2 = "B",
                        split_bias_over = "months",
...
six_ridge9 <- ridge_plot(your_SE = six_SE,
                        split_bias_on = "celltype",
                        bias_1 = "T",
                        bias_2 = "NK",
                        split_bias_over = "months",
...
six_ridge10 <- ridge_plot(your_SE = six_SE,
                        split_bias_on = "celltype",
                        bias_1 = "B",
                        bias_2 = "NK",
                        split_bias_over = "months",
...
six_circos2 <- function() circos_plot(six_SE[,six_circos_selection2],
                                     weighted = TRUE,
                                     plot_label = "celltype",
                                     text_size = figS2_txsz)

six_circos_selection3 <- c("m55_GRANULOCYTES","m55_NKCELLS","m55_MONOCYTES")
six_circos3 <- function() circos_plot(six_SE[,six_circos_selection3],
                                     weighted = TRUE,
                                     plot_label = "celltype",
                                     text_size = figS2_txsz)

six_circos_selection4 <- c("m55_TCELLS","m55_BCELLS","m55_NKCELLS")
six_circos4 <- function() circos_plot(six_SE[,six_circos_selection4],
                                     weighted = TRUE,
                                     plot_label = "celltype",
                                     text_size = figS2_txsz)

pdf(file = file.path(results_dir, "Figure_S2.pdf"), width = 11, height = 8)
...
## Figure S3: Further Clonal Bias from Koelle et al
...
# Ridge plots
ko_ridge2 <- ridge_plot(your_SE = koelle_SE,
                       split_bias_on = "celltype",
                       bias_1 = "Gr",
                       bias_2 = "Mo",
                       split_bias_over = "months",
...
ko_ridge3 <- ridge_plot(your_SE = koelle_SE,
                       split_bias_on = "celltype",
                       bias_1 = "Mo",
                       bias_2 = "T",
                       split_bias_over = "months",
...
pdf(file = file.path(results_dir, "Figure_S3.pdf"), width = 8, height = 4)
...
## Figure S4: Clone number and diversity of Clarke et al TCR data

```{r figure S4, eval = TRUE}

figS4_text_size <- 6 

clarke_cc <- count_clones(clarke_SE,
                              plot_over = "months",
                              group_by = "SAMPLENAME",
                              index_type = "count",
                              point_size = 2,
                              line_size = 1,
                              text_size = figS4_text_size)+
  ggplot2::theme(legend.position = "none")
...
pdf(file = file.path(results_dir, "Figure_S4.pdf"), width = 7, height = 8/3)
