#' Bar Plot of Hematopoietic Contribution from top n clones
#'
...
#'@examples
#'clone_bar_plot(your_data = ZG66_simple_data, filter_by = "Cell_type", filter_selection = "B", plot_by = "Timepoint", n_clones = 20)
#'@export

clone_bar_plot <- function(your_SE, filter_by, filter_selection, plot_by, n_clones = 10, linesize = 0.5, text_size = 15){
  ...
  # Combine emergence and percentage data
