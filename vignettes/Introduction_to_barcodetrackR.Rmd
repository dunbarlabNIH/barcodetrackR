...
```{r cor_plot 2, eval = plot_figures, fig.width = 6, fig.height = 5}
wu_cor_plot_sample_selection <- colData(wu_SE)$SAMPLENAME[1:20]
cor_plot(wu_SE[,wu_cor_plot_sample_selection],
         method_corr = "pearson",
         plot_type = "color",
...
```{r cor_plot 3, eval = plot_figures}
cor_plot(wu_SE[,wu_cor_plot_sample_selection],
         method_corr = "pearson",
         assay = "proportions",
...
```{r cor_plot 4, eval = plot_figures, fig.width = 4, fig.height = 3, warning=FALSE, message=FALSE}
...
```{r dist plot 1, eval = plot_figures, fig.width = 7, fig.height = 5}
...
```{r dist plot 2, eval = plot_figures, fig.width = 7, fig.height = 5}
dist_plot(wu_SE[,wu_cor_plot_sample_selection],
          dist_method =  "cosine",
          plot_type = "color",
          assay = "logs",
...
```{r barcode_ggheatmap wu_SE 1, echo=TRUE, warning = FALSE, fig.width = 8, fig.height=8, eval = plot_figures}
...
```{r barcode_ggheatmap six_SE, echo=TRUE, warning = FALSE, fig.width = 8, fig.height=6, eval = plot_figures}
...
```{r barcode_ggheatmap_stat wu_SE, echo=TRUE, warning = FALSE, fig.width = 8, fig.height=6, eval = plot_figures}
...
```{r barcode_stat_test wu_SE, eval = plot_figures, echo=TRUE, warning = FALSE}
...
```{r binary_heat_map, echo=TRUE, warning = FALSE, eval = plot_figures}
...
```{r clonal_contribution wu_SE, echo=TRUE, warning = FALSE, eval = plot_figures}
...
```{r bias_histogram wu_SE, echo=TRUE, warning = FALSE, eval = plot_figures}
...
```{r bias_histogram six_SE, echo=TRUE, warning = FALSE, eval = plot_figures}
...
```{r bias_ridge_plot wu_SE 1, echo=TRUE, warning = FALSE, message=FALSE, eval = plot_figures}
...
```{r bias_ridge_plot wu_SE 2, echo=TRUE, warning = FALSE, message=FALSE, eval = plot_figures}
bias_ridge_plot(your_SE = wu_SE,
                split_bias_on = "celltype",
                bias_1 = "B",
                bias_2 = "Gr",
...
```{r bias_lineplot six_SE, echo=TRUE, warning = FALSE, eval = plot_figures}
...
```{r clone counts 1, eval = plot_figures}
...
```{r clone counts cumulative, eval = plot_figures}
clonal_count(your_SE = six_SE,
             plot_over = "months",
             group_by = "celltype",
             cumulative = TRUE)
...
```{r belderbos rank_abundance, eval = plot_figures}
...
```{r belderbos rank_abundance stat_test, eval = plot_figures, warning = FALSE}
...
```{r wu shannon, eval = plot_figures}
...
```{r belderbos shannon, eval = plot_figures}
...
```{r six simpson, eval = plot_figures}
...
```{r wu bray diversity, eval = plot_figures}
...
```{r six bray diversity, eval = plot_figures}
...
```{r chord_diagram wu_SE 1, echo=TRUE, warning = FALSE, eval = plot_figures}
...
```{r chord_diagram wu_SE 2, echo=TRUE, warning = FALSE, eval = plot_figures}
...
```{r chord_diagram wu_SE 3, echo=TRUE, warning = FALSE, eval = plot_figures}
...
```{r chord_diagram belderbos_SE 1, echo=TRUE, warning = FALSE, eval = plot_figures}
belderbos_wk_samples_PB <- c("wk9_U", "wk14_U", "wk20_U", "wk22_U")
...
```{r chord_diagram belderbos_SE 2, echo=TRUE, warning = FALSE, eval=plot_figures}
chord_diagram(belderbos_SE[,belderbos_wk_samples_PB],
            weighted = TRUE)
```
