...
# When saving chord diagrams to variables, I have to use this hacky way of doing it :/
ko_chord_selection <- c("ZH33_38m_Gr_Ficoll","ZH33_38m_T","ZH33_38m_Mono")
ko_chord <- function() chord_diagram(koelle_SE[,ko_chord_selection],
                                    weighted = TRUE,
                                    plot_label = "celltype",
                                    text_size = fig5_txsz)
six_chord_selection <- c("m55_GRANULOCYTES","m55_TCELLS","m55_MONOCYTES")
six_chord <- function() chord_diagram(six_SE[,six_chord_selection],
                                     weighted = TRUE,
                                     plot_label = "celltype",
                                     text_size = fig5_txsz)

pdf(file = file.path(results_dir, "Figure_5.pdf"), width = 8, height = 8)
cowplot::plot_grid(six_ridge, six_chord, ko_ridge, ko_chord,
...
# Chord diagrams
six_chord_selection2 <- c("m55_GRANULOCYTES","m55_BCELLS","m55_MONOCYTES")
six_chord2 <- function() chord_diagram(six_SE[,six_chord_selection2],
                                     weighted = TRUE,
                                     plot_label = "celltype",
                                     text_size = figS2_txsz)

six_chord_selection3 <- c("m55_GRANULOCYTES","m55_NKCELLS","m55_MONOCYTES")
six_chord3 <- function() chord_diagram(six_SE[,six_chord_selection3],
                                     weighted = TRUE,
                                     plot_label = "celltype",
                                     text_size = figS2_txsz)

six_chord_selection4 <- c("m55_TCELLS","m55_BCELLS","m55_NKCELLS")
six_chord4 <- function() chord_diagram(six_SE[,six_chord_selection4],
                                     weighted = TRUE,
                                     plot_label = "celltype",
                                     text_size = figS2_txsz)

pdf(file = file.path(results_dir, "Figure_S2.pdf"), width = 11, height = 8)
cowplot::plot_grid(six_ridge2, six_ridge3, six_ridge4, six_chord2,
                   six_ridge5, six_ridge6, six_ridge7, six_chord3,
                   six_ridge8, six_ridge9, six_ridge10, six_chord4,
