...
#'@param scale_rank Whether or not to scale all ranks from 0 to 1 or keep barcode ranks as their actual integer values. When `scale_rank` is set to FALSE, all samples will not necessarily have the same x maximum.
#'@param point_size Numeric. Size of the points for the plot.
#'@param your_title Specify a title for the plot.
