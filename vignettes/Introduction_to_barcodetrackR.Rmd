...
wu_dataframe <- read.delim("../inst/sample_data/WuC_etal/monkey_ZJ31.txt")
wu_metadat <- read.delim('/Users/mortlockrd/Desktop/GitHub/barcodetrackR/inst/sample_data/DunbarLab/monkey_ZJ31_metadata.txt')
se.monkey <- create_SE(your_data = barcode.monkey, meta_data = meta.monkey, threshold = 5e-4)
