...
```{r cor_plot 2, eval = TRUE, fig.width = 12, fig.height = 10, warning=FALSE, message=FALSE}
cor_plot(koelle_SE,
         method_corr = "pearson",
         plot_type = "circle")
```
...
```{r barcode_statistics wu_SE, eval = FALSE, echo=TRUE, warning = FALSE}
...
head(wu_CD16_NK_statistics$p_val[,4:8])
```
