...
## Installation
Currently, [barcodetrackR](http://github.com/diegoalexespi/barcodetrackR) is available at Github and can be downloaded using the devtools package.
```{r installation, eval = FALSE}
devtools::install_github("diegoalexespi/barcodetrackR")
```

## Contributors
The R package and functions were created by Diego A. Espinoza, Ryland Mortlock, Samson J. Koelle, and others at Cynthia Dunbar's laboratory at the National Heart, Lung, and Blood Institutes of Health. Issues should be addressed to https://github.com/diegoalexespi/barcodetrackR/issues.
