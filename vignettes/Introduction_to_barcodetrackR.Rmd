...
```{r cor_plot 4, eval = FALSE, fig.width = 3, fig.height = 2, warning=FALSE, message=FALSE}
...
The Belderbros dataset generally contains less clones than either the Wu or Six datasets, likely because the data is from mice.  Here is a heat map showing some detailed information about the top clones from the peripheral blood samples across time.
