...
barcode.file <- read.delim("~/Documents/dunbar_lab/projects/diego_barcodetrackR/barcodetrackR/inst/sample_data/ZG66_simple_data.txt", row.names = 1)
meta.file <- read.delim("~/Documents/dunbar_lab/projects/diego_barcodetrackR/barcodetrackR/inst/sample_data/ZG66_simple_metadata.txt") %>% dplyr::mutate(SAMPLENAME = FILENAME)
