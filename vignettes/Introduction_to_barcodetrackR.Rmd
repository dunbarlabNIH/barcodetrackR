...
### A.1 Creating SummarizedExperiment objects

The _barcodetrackR_ package operates on SummarizedExperiment objects from Bioconductor. It stores metadata in here as well. It also includes sample data from published cellular barcoding experiments. For this vignette, we will load data from publically available data from the following papers:
...
### A.2 Adding custom assays to the SummarizedExperiment objects
