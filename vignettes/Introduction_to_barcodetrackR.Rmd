...
system.file("extdata", "/WuC_etal/monkey_ZJ31.txt", package = "barcodetrackR") %>%
  read.delim(row.names = 1) -> wu_dataframe

system.file("extdata", "/WuC_etal/monkey_ZJ31_metadata.txt", package = "barcodetrackR") %>%
